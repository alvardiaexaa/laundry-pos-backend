...
Route::post('/cashiers', [AuthController::class, 'registerCashier']);
Route::put('/cashiers/{email}', [AuthController::class, 'updateCashier']);
Route::delete('/cashiers/{email}', [AuthController::class, 'deleteCashier']);
